	...
	<div class="limiter">
		...
		if(isset($_SESSION['user_added']) && $_SESSION['user_added'] == 1)
		{
			...
			<div class="container text-center">
				<h5>User was added successfully, Login to Continue</h5>
			</div>
			<?php
		...
		if (isset($_SESSION['user_exists']) && $_SESSION['user_exists'] == 1)
		{
			?>
			<div class="container text-center">
				<h5>User already user_exists, Login to Continue</h5>
			</div>
			<?php
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="user_check.php" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter Email">
						<input class="input100" type="email" name="email" placeholder="abcd@domain.com">
